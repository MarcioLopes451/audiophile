    ...
    <div className='mt-10'>
        <div className='flex justify-center items-center flex-col gap-5 xl:flex-row-reverse'>
          {width < breakPoint ? <Image src={Testimonials} alt='testimonials' className='w-80 rounded-lg'/> :
           ...
           <Image src={DesktopTestimonials} alt='testimonials' className='rounded-lg'/>}
          <div className='mt-10 flex flex-col justify-center items-center text-center px-4 xl:w-[550px] xl:text-left'>
            <p className='text-3xl tracking-wide font-semibold md:text-[48px] leading-[50px] xl:font-[40px]'>BRINGING YOU THE 
