        ...
        <div className="flex justify-center items-center flex-col md:flex-row md:px-[20px] md:gap-[69px] xl:px-0">
          ...
          <div className="mt-5 px-5">
            <div className="flex flex-col xl:w-[500px]">
              <h1>
                {productData.new ? (
                  <p className="tracking-[0.8rem] text-caramel text-sm">
                    NEW PRODUCT
                  </p>
                ) : null}
              </h1>
              ...
              <p className="mt-6 opacity-50 text-[15px] leading-7">
                {productData.description}
              </p>
              <p className="mt-6 font-semibold text-lg tracking-widest">
                ${productData.price.toLocaleString()}
              </p>
              <div className="mt-10">
                {quantity === 0 ? (
                  <button
                    className=" bg-caramel w-48 h-12 tracking-widest text-white font-manrope text-sm hover:bg-tangerine transition ease-in-out"
      ...
      >
        <div className="flex flex-col justify-center gap-6 xl:flex-row xl:gap-[350px]">
          ...
          <div className="mt-20 flex items-start flex-col md:flex-row md:justify-between xl:flex-col xl:mt-0 xl:justify-normal">
            ...
            <div className="flex flex-col gap-3 mt-5 md:mt-0 xl:mt-10">
              {productData.includes.map((data, id) => (
                <div key={id}>
